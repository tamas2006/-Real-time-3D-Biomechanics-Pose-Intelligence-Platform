  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-4 p-4 rounded-[28px] bg-[#0B1120]/75 border border-white/20 shadow-[0_20px_50px_rgba(0,0,0,0.3)] backdrop-blur-2xl text-white">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        {/* GitHub Account Link Button */}
        <a
          href="https://github.com/tamas2006"
          target="_blank"
          rel="noopener noreferrer"
          onClick={() => sounds.playButtonClick()}
          className="flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-white/10 hover:bg-white/20 border border-white/20 text-xs font-mono font-bold text-white transition-all active:scale-90 shadow-sm hover:scale-105"
