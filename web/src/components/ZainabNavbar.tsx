    ...
    <nav className="relative z-40 flex items-center justify-between gap-4 max-w-7xl mx-auto w-full pt-2 px-2 select-none">
      ...
      <div className="flex items-center">
        <a
          ...
          className="flex items-center justify-center w-10 h-10 rounded-full bg-white/20 hover:bg-white/30 backdrop-blur-xl border border-white/40 shadow-sm transition-all active:scale-90 hover:scale-110 group"
          title="GitHub Profile (tamas2006)"
